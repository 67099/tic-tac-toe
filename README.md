...
A tic tac toe variant where each player only keeps 3 pieces on the board at a time. Placing a 4th piece removes your oldest one. Includes two AI agents to play against: Minimax with alpha beta pruning, and Monte Carlo Tree Search.
